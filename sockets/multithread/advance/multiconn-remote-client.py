##############################################################################
# 목적 : multithread socket client program (default : test node ip)          #
# 조건 : python3 이상                                                        #
# 예시 : 설명보기 > python multiconn-remote-client.py -h                     #
#        python multiconn-remote-client.py -n google.com -p 9999             #
#        python multiconn-remote-client.py -i 10.2.1.156 -p 9999             #
# -------------------------------------------------------------------------- #
