##############################################################################
# 목적 : single thread socket client program (default : 127.0.0.1)           #
# 조건 : python3 이상                                                        #
# 예시 : 설명보기 > python echo-client.py -h                                 #
#        python echo-client.py -n google.com -p 9999                         #
#        python echo-client.py -i 10.2.1.156 -p 9999                         #
# -------------------------------------------------------------------------- #
